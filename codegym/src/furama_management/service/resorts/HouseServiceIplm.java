...
import furama_management.repository.resorts.HouseRepositoryIplm;
...
public class HouseServiceIplm implements IService {
    HouseRepositoryIplm houseRepositoryIplm = new HouseRepositoryIplm();
    Scanner sc = new Scanner(System.in);
    Validate validate = new Validate();

    @Override
    public void disPlayList() {
        LinkedHashMap<House, Integer> integerMap = houseRepositoryIplm.showList();
        for (House f : integerMap.keySet()) {
    ...
    public void addNewList() {
        ...
        do {
            ...
            id = sc.nextLine();
            if (validate.regexIdHouse(id)) {
                System.out.println("Nhập id thành công");
            } else {
                System.err.println("Bạn nhập sai định dạng HO-XXXX");
            }
        ...
        do {
            ...
            switch (date1) {
                case "1":
                    do {
                        System.out.print("Bạn muốn thuê mấy năm: ");
        ...
        House house = new House(id, name, area, price, maxPerson, date, tieuChuan, soTang);
        houseRepositoryIplm.addList(house);
    }
}
